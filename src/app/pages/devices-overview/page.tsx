...
export default function DeviceOverview() {
    const [formData, setFormData] = useState<Device>({ name: "", description: "" });
            ...
            <div className="flex-col flex justify-center items-center space-y-8 mb-5">
                ...
                <div className="DeviceOverview space-y-5 sm:inline-flex sm:space-x-5 sm:space-y-0 ml-5 mr-5 justify-center items-center text-center">
                    <div className="w-80 h-24 sm:w-96 sm:h-32 border-2 bg-indigo-50 flex-col border-black border-solid">
                        <span className="text-base sm:text-lg font-bold ">Schlechteste Energieineffizienz</span><br/>
                        <span className="text-sm sm:text-base">Kühlschrank (200 kWh (Jahr) <br />mehr als Durchschnitt)</span>
                    </div>
                    <div className="w-80 h-24 sm:w-96 sm:h-32 border-2 bg-indigo-50 flex-col border-black border-solid">
                        <span className="text-base sm:text-lg font-bold">Zweit-schlechteste Energieeffizienz</span><br/>
                        <span className="text-sm sm:text-base">Haarföhn (300 kWh (Jahr) <br />mehr als Durchschnitt)</span>
                    </div>
                </div>
