        ...
        <div className="EditMemberDialog w-96 h-96 flex-col justify-center items-center inline-flex">
            <div className="EditMemberDialog w-96 h-96 relative flex-col justify-start items-start flex">
                ...
                <div className="EditMember w-96 h-96 relative">
                    <div className="EditMember w-96 h-96 px-12 py-20 left-0 top-[50px] absolute flex-col justify-start items-center gap-11 inline-flex">
                    ...
                    <div className="EditMember w-96 h-12 left-[60px] top-0 absolute text-center text-black text-3xl font-bold font-['Inter']">Haushaltsmitglied bearbeiten</div>
                </div>
            </div>
        </div>
    )
