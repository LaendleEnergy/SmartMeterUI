export default function AddMemberDialog() {
    return (
        <div className="AddMemberDialog w-96 h-96 relative">
            <div className="Background w-96 h-96 pl-96 pt-52 pb-72 left-[22px] top-[28px] absolute bg-indigo-50 rounded-sm border-2 border-black flex-col justify-start items-center inline-flex">
            ...
            <div className="AddMember w-96 h-96 left-[11px] top-[57px] absolute">
                <div className="AddMember w-96 h-96 px-12 py-20 left-0 top-[50px] absolute flex-col justify-start items-center gap-11 inline-flex">
                    <div className="Name justify-start items-start inline-flex">
                        <div className="Name justify-start items-start flex">
                            <div className="Name w-96 h-14 pl-3.5 pr-2.5 py-2.5 rounded border-4 border-black justify-start items-center gap-2.5 flex">
                                <div className="Name text-zinc-600 text-base font-normal font-['Inter'] tracking-wider">Name</div>
                            </div>
                        </div>
                    </div>
                    <div className="DateOfBirth justify-start items-start inline-flex">
                        <div className="DateOfBirth w-96 h-14 pl-3.5 pr-2.5 py-2.5 rounded border-4 border-black justify-start items-center gap-2.5 flex">
                            <div className="DateOfBirth text-zinc-600 text-base font-normal font-['Inter'] tracking-wider">Geburtsdatum (Optional)</div>
                        </div>
                    </div>
                    <div className="Gender w-96 h-14 pl-3.5 pr-2.5 py-2.5 rounded border-4 border-black justify-start items-center gap-2.5 inline-flex">
                        <div className="Gender text-zinc-600 text-base font-normal font-['Inter'] tracking-wider">Geschlecht (Optional)</div>
                    </div>
                ...
                <div className="AddMember w-96 h-12 left-[60px] top-0 absolute text-center text-black text-3xl font-bold font-['Inter']">Haushaltsmitglied hinzufügen</div>
            </div>
        </div>
    )
}