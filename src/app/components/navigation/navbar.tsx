...
function NavLink({ href, text }: NavLinkProps) {
  ...
  return (
    <Link href={href} className={isActive ? "PrimaryMedium w-28 px-5 py-2 bg-sky-600 rounded-full justify-center items-center flex" : "text-neutral-800 text-base font-medium font-['Inter'] leading-normal"}>{text}</Link>
  );
}
