    ...
    return (
        <div className="Account w-96 h-96 bg-white flex-col justify-start items-start gap-2.5 inline-flex">
            <div className="Page w-96 h-96 relative">
                ...
                <div className="Edit w-36 h-12 left-[769px] top-[167px] absolute justify-center items-center inline-flex">
                ...
                <div className="Information left-[674px] top-[132px] absolute text-black text-4xl font-bold font-['Inter']">Dein Haushalt</div>
                <div className="DeleteAccountButton w-72 h-14 left-[1269px] top-[878px] absolute">
                    <div className="PrimaryMedium w-72 h-14 px-5 py-2 left-0 top-0 absolute bg-red-600 rounded-full justify-center items-center inline-flex">
                        <div className="Default text-center text-white text-xl font-medium font-['Inter'] leading-normal">Account löschen</div>
                    </div>
                    <div className="Icon w-12 h-12 p-3 left-[227px] top-[6px] absolute bg-red-600 rounded-lg justify-start items-start inline-flex">
